...
class HomePresenter extends ChangeNotifier {
  ...
  fetchBestSellingData() async {
    var bestSelling = await ProductRepository().getBestSellingProducts();
    print(bestSelling.products!.length);
    bestSellingProducts.addAll(bestSelling.products!);
    if (bestSelling.success! && bestSelling.products!.isNotEmpty) {
      bestSellings = true;
      notifyListeners();
    }
  }
